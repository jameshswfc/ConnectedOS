...
import { exportImplementationDocumentPdf } from "@/modules/projects/project-export-service";
...
export async function GET(_request: Request, { params }: Params) {
  try {
    ...
    return fileResponse(await exportImplementationDocumentPdf(await getProjectContext(), id));
  } catch (error) {
