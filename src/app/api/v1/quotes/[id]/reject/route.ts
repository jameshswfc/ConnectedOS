...
import { rejectQuote } from "@/modules/quoting/quotes/quote-approval-service";
...
export async function POST(request: Request, { params }: Params) {
  try {
    ...
    return NextResponse.json(successResponse(await rejectQuote(await getQuotingContext(), id, body.comments)));
  } catch (error) {
