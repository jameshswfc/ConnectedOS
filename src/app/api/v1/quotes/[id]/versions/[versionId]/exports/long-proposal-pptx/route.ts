...
import { exportQuoteLongProposalPptx } from "@/modules/quoting/quotes/quote-export-service";
...
export async function GET(_request: Request, { params }: Params) {
  try {
    ...
    const exportResult = await exportQuoteLongProposalPptx(await getQuotingContext(), id, versionId);
